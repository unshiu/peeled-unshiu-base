class BaseGenerator < Rails::Generator::NamedBase
  def initialize(runtime_args, runtime_options = {})
    ...
    if runtime_options[:version] != nil
      ...
      actual_version = Base::VERSION::STRING
      
      if min_version > actual_version
        raise "version error in BaseGenerator: except " + min_version + ", actual " + actual_version
      end
    end
  end
  ...
  def manifest
    record do |m| 
      prefix = 'vendor/plugins/base/generators/base/templates/'
